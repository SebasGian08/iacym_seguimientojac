    ...
    <div class="sidebar-menu-wrapper">
        ...
        <div class="sidebar_mobile_menu">
            ...
            <div class="msb_widget brand_logo text-center">
                <a href="index.html">
                    <img src="<?= media() ?>/tiendacambio/images/logo/logo_25_1x.png"
                        srcset="<?= media() ?>/tiendacambio/images/logo/logo_25_1x.png 2x" alt="logo_not_found">
                </a>
            </div>
...
================================================== -->
    ...
    <header class="header_section electronic_header clearfix">
        <div class="header_advertisement">
            <img src="<?= media() ?>/tiendacambio/images/offer/electronic/img_01.png" alt="image_not_found">
        </div>
                    ...
                    <div class="col-lg-6">
                        <form method="get" action="<?= base_url() ?>/tienda/search">
                            <div class="medical_search_bar">
                                ...
                                <button type="submit" class="submit_btn zmdi-search"><i
                ...
                <div class="container-fluid prl_90">
                    <form method="get" action="<?= base_url() ?>/tienda/search">
                        <div class="form_item mb-0">
                            <input type="text" name="s" placeholder="Buscar...">
                            <button type="submit" class="submit_btn zmdi-search"><i class="fal fa-search"></i></button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="container maxw_1600">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 d-flex align-items-center justify-content-lg-end">
                        ...
                        <div class="">
                            <a class="custom_btn btn_sm bg_electronic_blue"
                                href="https://ismcmineriajyeeirl.com/brochurejye.pdf" target="_blank">
                                <i class="fal fa-download" style="margin-right: 8px;"></i> Descargar Brochure
                            </a>
                        </div>
