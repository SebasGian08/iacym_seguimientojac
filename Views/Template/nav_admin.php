    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= media();?>/images/usuario_ico.png"
                alt="User Image">
            <div>
        ...
        <ul class="app-menu">
            ...
            <li>
                <a class="app-menu__item" href="<?= base_url(); ?>/citas">
            ...
            <li>
                <a class="app-menu__item" href="<?= base_url(); ?>/medicos">
                    ...
                    <span class="app-menu__label">Medicos</span>
                </a>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <?php } ?>
                    <?php if(!empty($_SESSION['permisos'][6]['r'])){ ?>
                    <li><a class="treeview-item" href="<?= base_url(); ?>/portadas"><i class="icon fa fa-circle-o"></i>
                            Portada Principal</a></li>
                    <?php } ?>
                </ul>
            </li>
            <?php } ?>
            ...
            <li class="treeview">
                <a class="app-menu__item" href="#" data-toggle="treeview">
                    <i class="app-menu__icon fa fa-archive" aria-hidden="true"></i>
                    <span class="app-menu__label">Información Paciente</span>
                    <i class="treeview-indicator fa fa-angle-right"></i>
                </a>
                <ul class="treeview-menu">
            ...
            <li>
                <a class="app-menu__item" href="<?= base_url(); ?>/contactos">
                    ...
                    <span class="app-menu__label">Opiniones y valoraciones </span>
                </a>
            </li>
            <?php } ?>
